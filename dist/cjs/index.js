...
exports.AuthUser = exports.User = void 0;
...
Object.defineProperty(exports, "User", { enumerable: true, get: function () { return userAdmin_1.User; } });
class AuthUser {
    constructor(user) {
        this.authenticated = false;
        this.authenticate = (password) => {
            var digest = crypto_1.default.createHash('sha256').update(password.toString()).digest('hex');
            if (!this.password) {
                if (this.verbose) {
...
class Authentication {
    constructor(app, config, pool) {
        ...
        this.findByJWT = async (token) => {
            var digest = crypto_1.default.createHash('sha256').update(token.toString()).digest('hex');
        ...
        this.isAuthenticatedView = async (req, res, next) => {
            ...
            if (req.query) {
                ...
                path += "&" + qs_1.default.stringify(req.query);
            }
            else {
        ...
        this.isWriterView = async (req, res, next) => {
            ...
            if (req.query) {
                ...
                query_string += "&" + qs_1.default.stringify(req.query);
            }
            else {
                if (this.config.verbose) {
                    console.log("no query string");
        ...
        this.FileStore = (0, session_file_store_1.default)(express_session_1.default);
